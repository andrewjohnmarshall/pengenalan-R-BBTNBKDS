...
#' 
#' Pipe digunakan secara luas dalam tidyverse. Satu-satunya pengecualian adalah `{ggplot2}`: package ini ditulis sebelum pipe dibuat.
#' 
#' > Pipes are widely used in the tidyverse. The only exception is {ggplot2}: it was written before the pipe was created. 
#' 
#' # tibble / tibbles
#' 
